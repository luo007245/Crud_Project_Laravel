  ...
  <div class="modal-dialog">
    <div class="modal-content"> 
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">CRUD MENU</h5>
      ...
      <div class="modal-body">
        <form action="insertData" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-2">
                <input type="text" placeholder="Enter Product Name" class="form conntrol" name="pname" id=""></div>
            <div class="mb-2">
                <input type="text" placeholder="Enter Product price" class="form conntrol" name="pprice" id=""></div>
            <div class="mb-2">
                <input type="file"name="image" class="form conntrol" name="" id=""></div>
            <button type="submit" class="btn btn-outline-danger fw-bold fs 4 rounded-pill"> Add Data</button>
        </form>
        ...
      </div>
...
<table class="table mt-5">
    ...
    <tbody class="text-dander bg-Aqua fs-4">
